...
---------------
## Using SSH Key
1. mkdir -p "/d/Test Keygen"
2. ssh-keygen -t ed25519 -C "your_email@example.com" -f "/d/Test Keygen/github_ed25519"
3. cat "/d/Test Keygen/github_ed25519.pub"
4. GitHub -> Settings -> SSH and GPG keys -> New SSH key
5. git remote add origin git@github.com.Basil1361/Repo-Testing.git
6. eval "$(ssh-agent -s)"
7. ssh-add "/d/Test Keygen/github_ed25519"
